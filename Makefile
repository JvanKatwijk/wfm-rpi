#############################################################################
# Makefile for building: linux-bin/wfm-rpi-1.0
...
INCPATH       = -I. -I. -Iincludes -Iincludes/output -Iincludes/various -Iincludes/fm -Iincludes/rds -Iincludes/various -Idevices -isystem /usr/include/qt4 -Idevices/rtlsdr-handler -Idevices/sdrplay-handler -Idevices/airspy-handler -I../../../../local/include/libairspy -I../../../../include/qt5 -I../../../../include/qt5/QtWidgets -I../../../../include/qt5/QtGui -I../../../../include/qt5/QtCore -I. -I../../../../include/libdrm -I. -I../../../../lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = wfm-rpi-1.01.0.0
DISTDIR = /usr/shared/sdr-j-development/systems/wfm-rpi/.tmp/wfm-rpi-1.01.0.0
LINK          = g++
LFLAGS        = -flto -Wl,-O1
...
SOURCES       = main.cpp \
		...
		devices/airspy-handler/airspy-handler.cpp qrc_resources.cpp \
		moc_radio.cpp \
...
QMAKE_TARGET  = wfm-rpi-1.0
DESTDIR       = linux-bin/
TARGET        = linux-bin/wfm-rpi-1.0


first: all
####### Build rules

$(TARGET): ui_sdrgui.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_airspy-widget.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents radio.h includes/popup-keypad.h includes/fm-constants.h includes/various/squelchClass.h includes/various/fft.h includes/various/oscillator.h includes/various/ringbuffer.h includes/various/pllC.h includes/various/Xtan2.h includes/various/sincos.h includes/various/resampler.h includes/various/converter.h includes/various/fir-filters.h includes/various/fft-filters.h includes/various/iir-filters.h includes/various/program-list.h includes/output/audio-base.h includes/output/audiosink.h includes/fm/fm-demodulator.h includes/fm/fm-processor.h includes/fm/fm-decoder.h includes/fm/fm-levels.h includes/rds/rds-decoder.h includes/rds/rds-blocksynchronizer.h includes/rds/rds-group.h includes/rds/rds-groupdecoder.h includes/rds/charsets.h devices/device-handler.h devices/rtlsdr-handler/rtlsdr-handler.h devices/rtlsdr-handler/dongleselect.h devices/sdrplay-handler/sdrplay-handler.h devices/sdrplay-handler/sdrplayselect.h devices/airspy-handler/airspy-handler.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp radio.cpp src/popup-keypad.cpp src/various/fft.cpp src/various/oscillator.cpp src/various/pllC.cpp src/various/Xtan2.cpp src/various/sincos.cpp src/various/resampler.cpp src/various/fir-filters.cpp src/various/fft-filters.cpp src/various/iir-filters.cpp src/various/program-list.cpp src/output/audio-base.cpp src/output/audiosink.cpp src/fm/fm-demodulator.cpp src/fm/fm-processor.cpp src/fm/fm-decoder.cpp src/fm/fm-levels.cpp src/rds/rds-decoder.cpp src/rds/rds-blocksynchronizer.cpp src/rds/rds-group.cpp src/rds/rds-groupdecoder.cpp src/rds/charsets.cpp devices/device-handler.cpp devices/rtlsdr-handler/rtlsdr-handler.cpp devices/rtlsdr-handler/dongleselect.cpp devices/sdrplay-handler/sdrplay-handler.cpp devices/sdrplay-handler/sdrplayselect.cpp devices/airspy-handler/airspy-handler.cpp $(DISTDIR)/
	$(COPY_FILE) --parents sdrgui.ui devices/rtlsdr-handler/dabstick-widget.ui devices/sdrplay-handler/sdrplay-widget.ui devices/airspy-handler/airspy-widget.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_radio.cpp moc_popup-keypad.cpp moc_program-list.cpp moc_audio-base.cpp moc_audiosink.cpp moc_fm-demodulator.cpp moc_fm-processor.cpp moc_fm-decoder.cpp moc_rds-decoder.cpp moc_rds-blocksynchronizer.cpp moc_rds-groupdecoder.cpp moc_device-handler.cpp moc_rtlsdr-handler.cpp moc_dongleselect.cpp moc_sdrplay-handler.cpp moc_sdrplayselect.cpp moc_airspy-handler.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_radio.cpp moc_popup-keypad.cpp moc_program-list.cpp moc_audio-base.cpp moc_audiosink.cpp moc_fm-demodulator.cpp moc_fm-processor.cpp moc_fm-decoder.cpp moc_rds-decoder.cpp moc_rds-blocksynchronizer.cpp moc_rds-groupdecoder.cpp moc_device-handler.cpp moc_rtlsdr-handler.cpp moc_dongleselect.cpp moc_sdrplay-handler.cpp moc_sdrplayselect.cpp moc_airspy-handler.cpp
moc_radio.cpp: ../../../../include/qt5/QtWidgets/QDialog \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/output -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/fm -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/rds -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices -I/usr/include/qt4 -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/airspy-handler -I/usr/local/include/libairspy -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-redhat-linux -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-redhat-linux/7/include -I/usr/local/include -I/usr/include radio.h -o moc_radio.cpp
...
moc_audiosink.cpp: ../../../../include/qt5/QtCore/QString \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/output -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/fm -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/rds -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices -I/usr/include/qt4 -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/airspy-handler -I/usr/local/include/libairspy -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-redhat-linux -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-redhat-linux/7/include -I/usr/local/include -I/usr/include includes/output/audiosink.h -o moc_audiosink.cpp
...
moc_fm-demodulator.cpp: ../../../../include/qt5/QtCore/QObject \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/output -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/fm -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/rds -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices -I/usr/include/qt4 -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/airspy-handler -I/usr/local/include/libairspy -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-redhat-linux -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-redhat-linux/7/include -I/usr/local/include -I/usr/include includes/fm/fm-demodulator.h -o moc_fm-demodulator.cpp
...
moc_fm-decoder.cpp: includes/fm-constants.h \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/output -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/fm -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/rds -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices -I/usr/include/qt4 -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/rtlsdr-handler -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/sdrplay-handler -I/usr/shared/sdr-j-development/systems/wfm-rpi/devices/airspy-handler -I/usr/local/include/libairspy -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/7 -I/usr/include/c++/7/x86_64-redhat-linux -I/usr/include/c++/7/backward -I/usr/lib/gcc/x86_64-redhat-linux/7/include -I/usr/local/include -I/usr/include includes/fm/fm-decoder.h -o moc_fm-decoder.cpp
...
compiler_uic_make_all: ui_sdrgui.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_airspy-widget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_sdrgui.h ui_dabstick-widget.h ui_sdrplay-widget.h ui_airspy-widget.h

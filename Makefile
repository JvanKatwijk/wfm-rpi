#############################################################################
# Makefile for building: linux-bin/wfm-rpi-sdrplay-0.996
...
CC            = gcc
CXX           = g++
DEFINES       = -DHAVE_SDRPLAY -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -pg -O2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -pg -O2 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -I. -Iincludes -Iincludes/output -Iincludes/various -Iincludes/fm -Iincludes/rds -Iincludes/various -Iinput -isystem /usr/include/qt4 -Iinput/sdrplay -I../../../../include/qt5 -I../../../../include/qt5/QtWidgets -I../../../../include/qt5/QtGui -I../../../../include/qt5/QtCore -I. -I. -I../../../../lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = wfm-rpi-sdrplay-0.9961.0.0
DISTDIR = /usr/shared/sdr-j-development/systems/wfm-rpi/.tmp/wfm-rpi-sdrplay-0.9961.0.0
LINK          = g++
LFLAGS        = -pg -Wl,-O1
...
SOURCES       = main.cpp \
		...
		input/sdrplay/sdrplayselect.cpp moc_gui.cpp \
...
DIST          = ../../../../lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		input/sdrplay/sdrplayselect.h main.cpp \
		gui.cpp \
		src/popup-keypad.cpp \
		src/various/fft.cpp \
		src/various/oscillator.cpp \
...
QMAKE_TARGET  = wfm-rpi-sdrplay-0.996
DESTDIR       = linux-bin/
TARGET        = linux-bin/wfm-rpi-sdrplay-0.996


first: all
####### Build rules

$(TARGET): ui_sdrgui.h ui_sdrplay-widget.h $(OBJECTS)  
...
moc_predefs.h: ../../../../lib64/qt5/mkspecs/features/data/dummy.cpp
	g++ -pipe -pg -O2 -Wall -W -dM -E -o moc_predefs.h ../../../../lib64/qt5/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_gui.cpp moc_popup-keypad.cpp moc_program-list.cpp moc_audio-base.cpp moc_audiosink.cpp moc_fm-demodulator.cpp moc_fm-processor.cpp moc_fm-decoder.cpp moc_rds-decoder.cpp moc_rds-blocksynchronizer.cpp moc_rds-groupdecoder.cpp moc_virtual-input.cpp moc_sdrplay.cpp moc_sdrplayselect.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_gui.cpp moc_popup-keypad.cpp moc_program-list.cpp moc_audio-base.cpp moc_audiosink.cpp moc_fm-demodulator.cpp moc_fm-processor.cpp moc_fm-decoder.cpp moc_rds-decoder.cpp moc_rds-blocksynchronizer.cpp moc_rds-groupdecoder.cpp moc_virtual-input.cpp moc_sdrplay.cpp moc_sdrplayselect.cpp
moc_gui.cpp: ../../../../include/qt5/QtWidgets/QDialog \
		...
		moc_predefs.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/output -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/fm -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/rds -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/input -I/usr/include/qt4 -I/usr/shared/sdr-j-development/systems/wfm-rpi/input/sdrplay -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/6.2.1 -I/usr/include/c++/6.2.1/x86_64-redhat-linux -I/usr/include/c++/6.2.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/6.2.1/include -I/usr/local/include -I/usr/include gui.h -o moc_gui.cpp
...
compiler_uic_make_all: ui_sdrgui.h ui_sdrplay-widget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_sdrgui.h ui_sdrplay-widget.h

#############################################################################
# Makefile for building: linux-bin/wfm-rpi-elad-0.996
...
CC            = gcc
CXX           = g++
DEFINES       = -DSMALL_GUI -DHAVE_ELAD_S1 -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I. -Iincludes -Iincludes/output -Iincludes/various -Iincludes/fm -Iincludes/rds -Iincludes/various -Iinput -isystem /usr/include/qt4 -Iinput/sw-elad-s1 -I../../../../include/qt5 -I../../../../include/qt5/QtWidgets -I../../../../include/qt5/QtGui -I../../../../include/qt5/QtCore -I. -I. -I../../../../lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = wfm-rpi-elad-0.9961.0.0
DISTDIR = /usr/shared/sdr-j-development/systems/wfm-rpi/.tmp/wfm-rpi-elad-0.9961.0.0
LINK          = g++
LFLAGS        = -flto -Wl,-O1
...
SOURCES       = src/main.cpp \
		...
		input/sw-elad-s1/elad-loader.cpp moc_gui.cpp \
...
DIST          = ../../../../lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		input/sw-elad-s1/elad-loader.h src/main.cpp \
		src/gui.cpp \
		src/popup-keypad.cpp \
		src/various/fft.cpp \
		src/various/oscillator.cpp \
...
QMAKE_TARGET  = wfm-rpi-elad-0.996
DESTDIR       = linux-bin/
TARGET        = linux-bin/wfm-rpi-elad-0.996


first: all
####### Build rules

$(TARGET): ui_sdrgui.h ui_elad_widget.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents includes/gui.h includes/popup-keypad.h includes/fm-constants.h includes/various/squelchClass.h includes/various/fft.h includes/various/oscillator.h includes/various/ringbuffer.h includes/various/pllC.h includes/various/Xtan2.h includes/various/sincos.h includes/various/resampler.h includes/various/converter.h includes/various/fir-filters.h includes/various/fft-filters.h includes/various/iir-filters.h includes/various/program-list.h includes/output/audio-base.h includes/output/audiosink.h includes/fm/fm-demodulator.h includes/fm/fm-processor.h includes/fm/fm-decoder.h includes/fm/fm-levels.h includes/rds/rds-decoder.h includes/rds/rds-blocksynchronizer.h includes/rds/rds-group.h includes/rds/rds-groupdecoder.h includes/rds/charsets.h input/virtual-input.h input/sw-elad-s1/elad-s1.h input/sw-elad-s1/elad-worker.h input/sw-elad-s1/elad-loader.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/gui.cpp src/popup-keypad.cpp src/various/fft.cpp src/various/oscillator.cpp src/various/pllC.cpp src/various/Xtan2.cpp src/various/sincos.cpp src/various/resampler.cpp src/various/fir-filters.cpp src/various/fft-filters.cpp src/various/iir-filters.cpp src/various/program-list.cpp src/output/audio-base.cpp src/output/audiosink.cpp src/fm/fm-demodulator.cpp src/fm/fm-processor.cpp src/fm/fm-decoder.cpp src/fm/fm-levels.cpp src/rds/rds-decoder.cpp src/rds/rds-blocksynchronizer.cpp src/rds/rds-group.cpp src/rds/rds-groupdecoder.cpp src/rds/charsets.cpp input/virtual-input.cpp input/sw-elad-s1/elad-s1.cpp input/sw-elad-s1/elad-worker.cpp input/sw-elad-s1/elad-loader.cpp $(DISTDIR)/
	$(COPY_FILE) --parents src/sdrgui.ui input/sw-elad-s1/elad_widget.ui $(DISTDIR)/
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_gui.cpp moc_popup-keypad.cpp moc_program-list.cpp moc_audio-base.cpp moc_audiosink.cpp moc_fm-demodulator.cpp moc_fm-processor.cpp moc_fm-decoder.cpp moc_rds-decoder.cpp moc_rds-blocksynchronizer.cpp moc_rds-groupdecoder.cpp moc_virtual-input.cpp moc_elad-s1.cpp moc_elad-worker.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_gui.cpp moc_popup-keypad.cpp moc_program-list.cpp moc_audio-base.cpp moc_audiosink.cpp moc_fm-demodulator.cpp moc_fm-processor.cpp moc_fm-decoder.cpp moc_rds-decoder.cpp moc_rds-blocksynchronizer.cpp moc_rds-groupdecoder.cpp moc_virtual-input.cpp moc_elad-s1.cpp moc_elad-worker.cpp
moc_gui.cpp: ../../../../include/qt5/QtWidgets/QDialog \
		...
		includes/gui.h \
		../../../../lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) -I/usr/lib64/qt5/mkspecs/linux-g++ -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/output -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/fm -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/rds -I/usr/shared/sdr-j-development/systems/wfm-rpi/includes/various -I/usr/shared/sdr-j-development/systems/wfm-rpi/input -I/usr/include/qt4 -I/usr/shared/sdr-j-development/systems/wfm-rpi/input/sw-elad-s1 -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/6.2.1 -I/usr/include/c++/6.2.1/x86_64-redhat-linux -I/usr/include/c++/6.2.1/backward -I/usr/lib/gcc/x86_64-redhat-linux/6.2.1/include -I/usr/local/include -I/usr/include includes/gui.h -o moc_gui.cpp
...
compiler_uic_make_all: ui_sdrgui.h ui_elad_widget.h
compiler_uic_clean:
	-$(DEL_FILE) ui_sdrgui.h ui_elad_widget.h

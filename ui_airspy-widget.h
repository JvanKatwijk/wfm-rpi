...
public:
    ...
    void setupUi(QWidget *airspyWidget)
    {
        ...
        airspy_Rate = new QLCDNumber(contents);
        airspy_Rate->setObjectName(QStringLiteral("airspy_Rate"));
        airspy_Rate->setGeometry(QRect(20, 110, 181, 23));
        airspy_Rate->setDigitCount(9);
        airspy_Rate->setSegmentStyle(QLCDNumber::Flat);
